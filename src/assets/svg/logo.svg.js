  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 85">
    <g transform="translate(-26 -14)">
      ...
      <rect
        ...
        width="22.4"
        height="2.04"
        transform="translate(49.8 83.36)"
      />
      <rect
        className="a"
        width="22.4"
        height="2.04"
        transform="translate(49.8 87.44)"
      />
      <path
        className="a"
        d="M63.9,71.25H44.3a1.048,1.048,0,0,0-1,.713,1,1,0,0,0,.4,1.142l6.489,4.427a6.993,6.993,0,0,0,7.829,0L64.5,73.105a1,1,0,0,0,.4-1.142A1.048,1.048,0,0,0,63.9,71.25Zm-7.091,4.612a4.928,4.928,0,0,1-5.418,0L47.622,73.29H60.578Z"
        transform="translate(6.9 20.27)"
      />
      <rect
        className="a"
        width="2.1"
        height="5.44"
        transform="translate(59.95 14)"
      />
      <path
        className="a"
        d="M0,0,5.481.069l.026,2.085L.026,2.085Z"
        transform="translate(74.79 22.756) rotate(-59.996)"
      />
      <path
        className="a"
        d="M0,0,2.085.026l.069,5.481L.069,5.481Z"
        transform="translate(42.591 19.064) rotate(-29.994)"
      />
      <path
        className="a"
        d="M0,0,5.562.069l.026,2.055L.026,2.055Z"
        transform="matrix(0.866, -0.5, 0.5, 0.866, 85.936, 32.091)"
      />
      <path
        className="a"
        d="M0,0,2.055.026l.069,5.562L.069,5.562Z"
        transform="matrix(0.5, -0.866, 0.866, 0.5, 30.163, 31.136)"
      />
      <rect
        className="a"
        width="5.6"
        height="2.04"
        transform="translate(90.4 45.499)"
      />
      <rect
        className="a"
        width="5.6"
        height="2.04"
        transform="translate(26 45.499)"
      />
      <path
        className="a"
        d="M0,0,2.055.026l.069,5.562L.069,5.562Z"
        transform="matrix(0.5, -0.866, 0.866, 0.5, 85.936, 60.971)"
      />
      <path
        className="a"
        d="M0,0,5.562.069l.026,2.055L.026,2.055Z"
        transform="translate(30.162 61.925) rotate(-30.004)"
      />
    </g>
  </svg>
)
